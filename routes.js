...
/*** ZONES ***/
router.get('/zones/:id/ManualOverride/:perc', async  (req, res) => {
    const command = deviceController.setManualOverride(req.params.id, req.params.perc);
    //res.json(command);
...
router.patch('/bridges/:id', async (req, res) => {
    try {
        const id = req.params.id;
        const updatedData = req.body;
        const options = { new: true };

        const result = await Bridge.findByIdAndUpdate(
...
//Devices CRUD
router.get('/devices/byParam/:type/:param',
    async (req, res) => {
...
//Read Modbus Datas
router.get('/read/:id', modbusController.readById)